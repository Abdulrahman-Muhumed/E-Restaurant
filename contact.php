...
<html lang="en">
    ...
    <body id="page-top">
        ...
        <!-- Contact -->
        <section class="page-section2 my-4" id="contact">
            <div class="container">
                <div class="text-center">
                    <h2 class="section-heading text-uppercase">Contact Us</h2>
                </div>
                <form id="contactForm" action="./contact.php" method="POST"   class="my-3 p-0">
                    ...
                    <div class="text-center">
                        <input class="btn btn-primary btn-xl text-uppercase" type="submit" name="SendMessage" value="Send Message">
                    </div>
                </form>
            </div>
        </section>
            ...
            <div class="container">
                <div class="row">
                    <div class="col text-center">
                        <h5 class="text-dark font-weight-bold ">You can also reach us throw</h5>
                    </div>
                </div>
                
                <div class="row text-center my-4">
                    <div class="col-md-12">
                        <i class="far fa-envelope fa-lg text-primary"></i>
                        <span class="text-dark font-weight-bold ml-5"> E-Resturant@res.org</span>
                    </div>
                   
                </div>
                <div class="row text-center my-4">
                    <div class="col-md-11 ml-4">
                        <i class="far fas fa-phone fa-lg text-primary ml-4"></i>
                        <span class="text-dark font-weight-bold ml-3 pl-5"> +966 599999999</span>
                    </div>
                ...
                <div class="row justify-content-center">
                    <div class="col-md-12 text-center">
                        ...
                        <div class="map my-4 " id="mymap">
                            <iframe src="https://maps.google.com/maps?q=College%20of%20Computer%20Science%20and%20Information%20Technology%20Building%20A11,%20College%20of%20Computer%20Science%20and%20Information%20Technology,%20Imam%20Abdulrahman%20bin%20Faisal%20University%D8%8C%20Dammam%2031451&t=&z=13&ie=UTF8&iwloc=&output=embed" width="600" height="450" frameborder="0" style="border:0" allowfullscreen></iframe>
                        </div>
                    </div>
                </div>
         ...
         function openmap() 
        {
            ...
            if(map.style.height === "30rem")
            {
                map.style.height = "0rem";
            }
            else
            {
