...
<body id="page-top">
    ...
    <section class="page-section" id="about">
        <div class="container">
            <div class="text-center">
                ...
                <h3 class="section-subheading text-muted">E-Resturant</h3>
            </div>
            <ul class="timeline">
                <li>
                ...
                <li class="timeline-inverted">
                    <div class="timeline-image">
                        ...
                        <img src="images/MainLogo.png" alt="" width="102%">
    ...
    <section class="page-section bg-light" id="team">
        <div class="container">
            <div class="text-center">
                <h2 class="section-heading text-uppercase pb-4">Team</h2>
            </div>
            <div class="carousel" data-flickity='{ "autoPlay": true }' >
                <div class="team-member mr-5">
                    <img class="mx-auto rounded-circle" src="images/blackwall.jpg" alt="" />
                    <h4>S-Name</h4>
