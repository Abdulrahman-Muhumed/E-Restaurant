...
<body id="page-top">
    ...
    <!-- Side settings -->
    <div class="sideControl" id="sideControl">
        <span>Font Size: </span>
        <button class="FontSizebtn" type="button" id="increaseSize" onclick="inSize()">
            +
        </button>
        <button class="FontSizebtn" type="button" id="decreaseSize" onclick="deSize()">
            -
        </button>

        <button class="sideControl-btn" type="button" onclick="ExpandSett()">
    ...
    <div class="carousel slide " data-ride="carousel" id="mycarousel">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img class="mycarousel_img" src="images/foodback1.jpg" alt="First slide">
            </div>
            <div class="carousel-item ">
                <img class="mycarousel_img" src="images/backpage3.jpg" alt="First slide">
            </div>


        </div>

        <a class="carousel-control-prev" href="#mycarousel" role="button" data-slide="prev" style="font-size: 35px;">

            <i class="fas fa-chevron-left"></i>

            <span class="sr-only">Previous</span>
        </a>
        <a class="carousel-control-next" href="#mycarousel" role="button" data-slide="next" style="font-size: 35px;">
    ...
    <!-- E-Restaurant-->
    <section class="page-section" id="Restaurant">
        <div class="container">
            <div class="text-center">
                <h2 class="section-heading text-uppercase font-weight-bold text-dark">E-Restaurant</h2>
                <h3 class="section-subheading text-muted">
                    <img src="./images/MainLogo.png" alt="" width="30px">
                    Welcome to E-Restaurant.
                </h3>
            </div>
            <div class="row ">
                <div class="col-md-6">
                    <img src="images/foodback4.jpg" alt="" class="bodyimg">

                </div>
                <div class="col-md-5 my-4">
                    <p style="text-align: justify;" class="my-5 text-dark">
                        Lorem ipsum dolor sit amet, consectetur adipisicing elit. Tempore alias culpa perferendis
                        explicabo. Recusandae fuga qui quae. Totam itaque amet magnam autem quisquam. Quas voluptates
                        laboriosam perferendis quisquam vero sequi voluptatibus provident reiciendis, earum fuga autem
                        distinctio consequuntur quibusdam.
                    </p>
                </div>
            ...
            <div class="row text-center">
                ...
                <div class="col-md-6">
                    <img src="images/page2IMG2.jpg" alt="" class=" bodyimg my-4">
                </div>
            </div>
    ...
    <section class="page-section" id="Menu">
        <div class="container">
            <div class="text-center">
                <h2 class="section-heading text-uppercase font-weight-bold text-dark">OUR Menu</h2>
            </div>
            <div class="carousel" data-flickity='{ "autoPlay": true }' class="p-0">

                <img class="pb-2 p-0" src="./images/Green-Plate.png" alt="" style="width: 100%; max-width: 250px;" />
                <img class="my-2 mr-5" src="./images/vegetarian-reci.png" alt="" style="width: 100%; max-width: 200px;" />
                <img class="my-4 mr-5" src="./images/E-res-Special.png" alt="" style="width: 100%; max-width: 150px;" />
                <img class="my-4 mr-5" src="./images/strawberry-slushie-feature.png" alt="" style="width: 100%; max-width: 150px;" />

                <div style="width: 250px; height: 200px; ">
                    <a href="./menu.php">
                        <h4 class="my-5 pt-5 font-weight-bold">View More</h4>
                    </a>
                </div>
